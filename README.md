...
Covasim 由疾病建模研究所开发，哥本哈根大学、伯内特研究所、GitHub
和微软公司也为其做出了贡献。
...
We also recommend, but do not require, installing Covasim in a virtual
...
Note: the CLI is currently not compatible with Windows. You will need to
